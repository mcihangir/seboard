...
//359343/941407/2.50/5/3/Power Supply
...
(library Library_1
	...
	(patternDef "SOT95P282X145-5N" (originalName "SOT95P282X145-5N")
		(multiLayer
	...
	(symbolDef "AP2204K-5.0TRG1" (originalName "AP2204K-5.0TRG1")
	...
	(compDef "AP2204K-5.0TRG1" (originalName "AP2204K-5.0TRG1") (compHeader (numPins 5) (numParts 1) (refDesPrefix PS)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP2204K-5.0TRG1"))
		(attachedPattern (patternNum 1) (patternName "SOT95P282X145-5N")
			(numPads 5)
			(padPinMap
		...
		(attr "Mouser Part Number" "621-AP2204K-5.0TRG1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AP2204K-5.0TRG1?qs=x6A8l6qLYDBM5Z%2F7Sw%252BT6g%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "AP2204K-5.0TRG1")
		(attr "Description" "0.2A 5V Low Dropout Regulator SOT-23 DiodesZetex AP2204K-5.0TRG1, LDO Voltage Regulator, 200mA, 5 V, 2.3  24 Vin, 5-Pin SOT-23")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/AP2204K-5.0TRG1.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "AP2204K-5.0TRG1.stp")
