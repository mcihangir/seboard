...
//15587958/941407/2.50/9/2/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SON65P300X300X63-9N" (originalName "SON65P300X300X63-9N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r90_30) (pt -1.45, 0.975) (rotation 90))
			(pad (padNum 2) (padStyleRef r90_30) (pt -1.45, 0.325) (rotation 90))
			(pad (padNum 3) (padStyleRef r90_30) (pt -1.45, -0.325) (rotation 90))
			(pad (padNum 4) (padStyleRef r90_30) (pt -1.45, -0.975) (rotation 90))
			(pad (padNum 5) (padStyleRef r90_30) (pt 1.45, -0.975) (rotation 90))
			(pad (padNum 6) (padStyleRef r90_30) (pt 1.45, -0.325) (rotation 90))
			(pad (padNum 7) (padStyleRef r90_30) (pt 1.45, 0.325) (rotation 90))
			(pad (padNum 8) (padStyleRef r90_30) (pt 1.45, 0.975) (rotation 90))
			(pad (padNum 9) (padStyleRef r235_160) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "AP7361E-33FGE-7" (originalName "AP7361E-33FGE-7")
	...
	(compDef "AP7361E-33FGE-7" (originalName "AP7361E-33FGE-7") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "ADJ/NC") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "PG") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "NC_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "EN") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP7361E-33FGE-7"))
		(attachedPattern (patternNum 1) (patternName "SON65P300X300X63-9N")
			(numPads 9)
			(padPinMap
		...
		(attr "Mouser Part Number" "621-AP7361E-33FGE-7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AP7361E-33FGE-7?qs=hd1VzrDQEGjeYIMlU6aeYw%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "AP7361E-33FGE-7")
		(attr "Description" "Wide Input Voltage Range: 2.2V to 6.0V  Output Voltage Accuracy: +/-1%  Very Low Dropout Voltage (3.3V): 360mV at 1A Typical  Low Quiescent Current (IQ): 60A Typical  Adjustable Output Voltage Range: 0.8V to 5.0V  Fixed Output Options: 1.0V, 1.2V, 1.5V, 1.8V, 2.5V, 2.8V and 3.3V  High PSRR: 75dB @ 1kHz  Current Limit: 1.5A  Fold-Back Short Circuit Protection: 400mA  Power-Good (PG) Output for Supply Monitoring and for Sequencing of Other Supplies")
		(attr "<Hyperlink>" "https://www.diodes.com/datasheet/download/AP7361E.pdf")
		(attr "<Component Height>" "0.63")
		(attr "<STEP Filename>" "AP7361E-33FGE-7.stp")
