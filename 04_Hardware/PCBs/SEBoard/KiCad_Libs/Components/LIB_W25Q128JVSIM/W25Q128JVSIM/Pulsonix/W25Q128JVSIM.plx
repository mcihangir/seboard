...
//804166/941407/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "W25Q128JVSIM" (originalName "W25Q128JVSIM")
	...
	(compDef "W25Q128JVSIM" (originalName "W25Q128JVSIM") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "__WP (IO2)") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "__HOLD OR __/RESET (IO3)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "W25Q128JVSIM"))
		...
		(attr "Mouser Part Number" "454-W25Q128JVSIM")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Winbond/W25Q128JVSIM?qs=qSfuJ%252Bfl%2Fd6d7A5WLggp6w%3D%3D")
		(attr "Manufacturer_Name" "Winbond")
		(attr "Manufacturer_Part_Number" "W25Q128JVSIM")
		(attr "Description" "128M-bit Serial Flash Memory with uniform 4KB sectors and Dual/Quad SPI")
		(attr "<Hyperlink>" "https://www.winbond.com/hq/search-resource-file.jsp?partNo=W25Q128JVSIM&type=datasheet")
		(attr "<Component Height>" "2.16")
		(attr "<STEP Filename>" "W25Q128JVSIM.stp")
