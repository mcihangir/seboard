...
(library Library_1
	...
	(compDef "W25Q128JVSIM" (originalName "W25Q128JVSIM") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "__HOLD OR __/RESET (IO3)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.winbond.com/hq/search-resource-file.jsp?partNo=W25Q128JVSIM&type=datasheet")
		(attr "Height" "2.16 mm")
	)
