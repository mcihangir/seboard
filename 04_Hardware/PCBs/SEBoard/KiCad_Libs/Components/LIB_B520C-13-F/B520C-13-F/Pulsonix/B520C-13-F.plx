...
(library Library_1
	...
	(symbolDef "B520C-13-F" (originalName "B520C-13-F")
	...
	(compDef "B520C-13-F" (originalName "B520C-13-F") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "B520C-13-F"))
		...
		(attr "Mouser Part Number" "621-B520C-F")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/B520C-13-F?qs=M9x7oF%252BgWA8vHz6ClNP3LA%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "B520C-13-F")
		(attr "Description" "Schottky Diodes & Rectifiers 20V 5A")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "2.5")
		(attr "<STEP Filename>" "B520C-13-F.stp")
