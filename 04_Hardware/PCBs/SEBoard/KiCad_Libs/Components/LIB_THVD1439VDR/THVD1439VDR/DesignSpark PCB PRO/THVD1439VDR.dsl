...
(library Library_1
	...
	(compDef "THVD1439VDR" (originalName "THVD1439VDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "VIO") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "R") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "DE/__RE") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/ds/symlink/thvd1439.pdf?ts=1633978341702&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTHVD1439")
		(attr "Height" "1.75 mm")
	)
