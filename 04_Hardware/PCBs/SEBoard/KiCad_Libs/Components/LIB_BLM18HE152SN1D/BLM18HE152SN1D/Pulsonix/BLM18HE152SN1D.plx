...
//12902885/941407/2.50/2/5/Ferrite Bead
...
(library Library_1
	...
	(patternDef "BLM18SP221SN1B" (originalName "BLM18SP221SN1B")
		(multiLayer
	...
	(symbolDef "BLM18HE152SN1D" (originalName "BLM18HE152SN1D")
	...
	(compDef "BLM18HE152SN1D" (originalName "BLM18HE152SN1D") (compHeader (numPins 2) (numParts 1) (refDesPrefix FB)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BLM18HE152SN1D"))
		(attachedPattern (patternNum 1) (patternName "BLM18SP221SN1B")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "81-BLM18HE152SN1D")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Murata-Electronics/BLM18HE152SN1D?qs=vNc2DXHODiLhczkT1FKS1Q%3D%3D")
		(attr "Manufacturer_Name" "Murata Electronics")
		(attr "Manufacturer_Part_Number" "BLM18HE152SN1D")
		(attr "Description" "Ferrite Beads 0603 1500ohms")
		...
		(attr "<STEP Filename>" "BLM18HE152SN1D.stp")
