...
//2427411/941407/2.50/6/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AP63301WU-7" (originalName "AP63301WU-7")
	...
	(compDef "AP63301WU-7" (originalName "AP63301WU-7") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP63301WU-7"))
		...
		(attr "Mouser Part Number" "621-AP63301WU-7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AP63301WU-7?qs=bZr6mbWTK5mxozg17S0lNg%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "AP63301WU-7")
		(attr "Description" "3.8V TO 32V INPUT, 3A LOW IQ SYNCHRONOUS BUCK WITH ENHANCED EMI REDUCTION.")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/AP63300-AP63301.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "AP63301WU-7.stp")
